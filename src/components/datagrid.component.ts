import {
	...
	AfterViewInit, ElementRef, ContentChildren, QueryList, NgZone, AfterContentInit, DoCheck, Renderer2, AfterViewChecked
} from '@angular/core';
...
export class DataGridComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy, AfterContentInit, DoCheck, AfterViewChecked {
	/** Self reference */
