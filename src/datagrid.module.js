...
@NgModule({
    imports: [CommonModule, NgbModule.forRoot(), FormsModule, DndModule.forRoot(), ResizableModule ],
    declarations: [DataGridComponent, RowComponent, GroupHeaderComponent, HeaderComponent, ControlsComponent, FiltersComponent, BodyComponent, CellComponent, TemplatesCellComponent, InfoComponent ],
